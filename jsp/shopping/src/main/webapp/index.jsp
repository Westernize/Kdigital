...
<head>
    ...
    <style>
        ...
        .action-buttons a {
            display: inline-block; padding: 12px 25px; margin: 10px; background-color: #28a745; color: white; text-decoration: none;
            border-radius: 5px; font-size: 1.1rem; transition: background-color 0.3s ease;
        }
        .action-buttons a:hover { background-color: #218838; }
        .user-info { font-weight: b; }
    </style>
</head>
<body>
    <div class="header">
